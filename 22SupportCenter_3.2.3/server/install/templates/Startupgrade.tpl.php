<div id="batchWizardStart" class="form_wrapper_outer" >
  <form id="wizard" name="wizardForm" action="?" method="Post">
    ...
    <fieldset>
    <legend>Start</legend>
      <p>Thank you for choosing Support Center. This wizard will lead you step by step through the upgrade of your copy of SupportCenter.</p>
      <p>Before execution of upgrade you should review list of changes in <a target="_blank" href="../../ChangeLog.txt">ChangeLog</a></p>
    </fieldset>
    <p>
